//! 2D physics container helpers.

use crate::modules::ui::types::ui::ResolvedLayout;
use macroquad::prelude::*;

/// Draw the optional background for a 2D physics container.
///
...
/// Lightweight standalone 2D physics container model.
#[derive(Debug, Clone, Copy)]
pub struct UIPhysicsContainer2D {
